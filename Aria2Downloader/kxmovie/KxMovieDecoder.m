...
//    _frame = av_frame_alloc(&_picture,
//                                    AV_PIX_FMT_RGB24,
...
//        return NO;
    ...
    int numBytes = av_image_get_buffer_size(AV_PIX_FMT_RGB24, _videoCodecCtx->width, _videoCodecCtx->height, 1);
    uint8_t *buffer = (uint8_t *)av_malloc(numBytes * sizeof(uint8_t));
    av_image_fill_arrays(_frame->data, _frame->linesize, buffer, AV_PIX_FMT_RGB24, _videoCodecCtx->width, _videoCodecCtx->height, 1);
